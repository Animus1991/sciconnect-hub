  ...
  return (
    <div className="h-14 px-3 sm:px-4 flex items-center justify-between border-b border-border bg-card flex-shrink-0">
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        <div onClick={onToggleInfo} role="button" tabIndex={0} onKeyDown={e => e.key === 'Enter' && onToggleInfo()} className="flex items-center gap-2.5 min-w-0 hover:opacity-80 transition-opacity cursor-pointer">
