      ...
      <TooltipProvider delayDuration={300}>
        <div className="max-w-[1200px] mx-auto">
          ...
          <motion.div
            ...
            className="flex items-center gap-1 p-1.5 bg-secondary/50 rounded-xl border border-border mb-5 overflow-x-auto"
          >
            {([
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-[13px] font-display font-medium transition-colors whitespace-nowrap ${
