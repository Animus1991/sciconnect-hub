...
import { Users, Search, MapPin, BookOpen, Award, ExternalLink, Check, TrendingUp, Globe, Filter } from "lucide-react";
...
const researchers = [
  { id: "r1", name: "Dr. Elena Vasquez", institution: "MIT", location: "Cambridge, MA", field: "Cognitive Science", hIndex: 28, papers: 47, followers: 312, initials: "EV", expertise: ["Neuroscience", "fMRI", "Cognitive Load"], trending: true },
  { id: "r2", name: "Prof. Marcus Chen", institution: "Stanford", location: "Palo Alto, CA", field: "AI & Machine Learning", hIndex: 41, papers: 83, followers: 1240, initials: "MC", expertise: ["Deep Learning", "NLP", "Interpretability"], trending: true },
  { id: "r3", name: "Dr. Amara Osei", institution: "Oxford", location: "Oxford, UK", field: "Philosophy of Science", hIndex: 15, papers: 29, followers: 178, initials: "AO", expertise: ["Epistemology", "Methodology"], trending: false },
  { id: "r4", name: "Dr. Yuki Tanaka", institution: "University of Tokyo", location: "Tokyo, Japan", field: "Computational Biology", hIndex: 33, papers: 61, followers: 892, initials: "YT", expertise: ["Bioinformatics", "Genomics", "ML"], trending: true },
  { id: "r5", name: "Prof. Sofia Reyes", institution: "Universitat de Barcelona", location: "Barcelona, Spain", field: "Behavioral Economics", hIndex: 22, papers: 38, followers: 445, initials: "SR", expertise: ["Decision Theory", "Psychology"], trending: false },
  { id: "r6", name: "Dr. James Okafor", institution: "University of Cambridge", location: "Cambridge, UK", field: "Climate Science", hIndex: 31, papers: 52, followers: 673, initials: "JO", expertise: ["Climate Modeling", "Earth Systems"], trending: false },
  { id: "r7", name: "Dr. Lisa Park", institution: "Caltech", location: "Pasadena, CA", field: "Quantum Computing", hIndex: 19, papers: 24, followers: 534, initials: "LP", expertise: ["Quantum Algorithms", "Error Correction"], trending: true },
  { id: "r8", name: "Prof. Omar Hassan", institution: "ETH Zürich", location: "Zürich, Switzerland", field: "Bioethics", hIndex: 26, papers: 44, followers: 389, initials: "OH", expertise: ["Ethics", "SynBio", "Policy"], trending: false },
];
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                        ...
                        {r.trending && (
                          <Badge variant="outline" className="text-[9px] font-display text-gold border-gold/30 bg-gold-muted flex items-center gap-0.5">
