...
const ResearchCard = ({
  ...
  return (
    ...
    >
      ...
      {/* Meta Row */}
      <div className="flex items-center flex-wrap gap-x-2.5 gap-y-1 text-[12px] text-muted-foreground mb-3">
        {journalRank[journal] && (
          <span className={`text-[10px] px-1.5 py-0.5 rounded font-bold ${journalRank[journal].color}`}>
      ...
      <div className="flex items-center gap-1 pt-3 border-t border-border">
        <button
          onClick={handleLike}
          className={`flex items-center justify-center gap-1.5 h-8 px-3 rounded-lg text-[13px] font-medium transition-all ${
            liked 
        ...
        <button className="flex items-center justify-center gap-1.5 h-8 px-3 rounded-lg text-[13px] font-medium text-muted-foreground hover:text-foreground hover:bg-secondary transition-all">
        ...
        <button 
          onClick={handleShare}
          className="flex items-center justify-center gap-1.5 h-8 px-3 rounded-lg text-[13px] font-medium text-muted-foreground hover:text-foreground hover:bg-secondary transition-all"
        >
