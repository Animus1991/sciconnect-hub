...
export const conversations: Conversation[] = [
  { id: "c1", type: "direct", name: "Dr. Sarah Chen", initials: "SC", participants: [contacts[0]], lastMessage: "I'll send you the dataset link shortly", lastMessageTime: "2m", lastMessageTimestamp: now - 120000, unread: 2, pinned: true, muted: false, archived: false, online: true, typing: true, linkedProject: "ML Reproducibility" },
  { id: "c2", type: "group", name: "ML Research Lab", initials: "ML", participants: [contacts[0], contacts[1], contacts[3]], lastMessage: "Meeting moved to Thursday", lastMessageTime: "15m", lastMessageTimestamp: now - 900000, unread: 5, pinned: true, muted: false, archived: false, description: "Weekly sync for ML reproducibility project", linkedProject: "ML Reproducibility", blockchainEnabled: true },
  { id: "c3", type: "direct", name: "Dr. Elena Volkov", initials: "EV", participants: [contacts[2]], lastMessage: "Thanks for the review feedback!", lastMessageTime: "1h", lastMessageTimestamp: now - hour, unread: 0, pinned: false, muted: false, archived: false, online: false },
  { id: "c4", type: "group", name: "CRISPR Ethics Committee", initials: "CE", participants: [contacts[4], contacts[5], contacts[6]], lastMessage: "Draft submitted to committee", lastMessageTime: "3h", lastMessageTimestamp: now - 3 * hour, unread: 1, pinned: false, muted: false, archived: false, description: "Ethics review for CRISPR gene-editing protocols", blockchainEnabled: true },
  { id: "c5", type: "direct", name: "Prof. Omar Hassan", initials: "OH", participants: [contacts[4]], lastMessage: "I agree with your assessment", lastMessageTime: "5h", lastMessageTimestamp: now - 5 * hour, unread: 0, pinned: false, muted: true, archived: false, online: false },
  { id: "c6", type: "direct", name: "Dr. Yuki Tanaka", initials: "YT", participants: [contacts[3]], lastMessage: "The Rayyan comparison is ready", lastMessageTime: "8h", lastMessageTimestamp: now - 8 * hour, unread: 0, pinned: false, muted: false, archived: false, online: true },
  { id: "c7", type: "group", name: "Grant Writing Team", initials: "GW", participants: [contacts[0], contacts[5], contacts[7]], lastMessage: "Budget section needs revision", lastMessageTime: "1d", lastMessageTimestamp: now - day, unread: 0, pinned: false, muted: false, archived: false, description: "NSF grant proposal coordination" },
  { id: "c8", type: "direct", name: "Dr. Priya Sharma", initials: "PS", participants: [contacts[6]], lastMessage: "The LNP delivery paper is published!", lastMessageTime: "2d", lastMessageTimestamp: now - 2 * day, unread: 0, pinned: false, muted: false, archived: true, online: true },
];
...
export const messagesData: Record<string, Message[]> = {
  c1: [
    ...
    { id: "m3", senderId: "u1", text: "Thanks! I've also set up automatic seed logging so every run is fully traceable.", time: "10:33 AM", timestamp: now - 12 * 60000, status: "read", reactions: [], evidenceTag: { type: "method", label: "Method", timestamp: now - 12 * 60000 } },
    ...
    { id: "m5", senderId: "me", text: "This looks amazing! The standard deviation dropped by 78%. Should we submit this to the reproducibility workshop?", time: "10:36 AM", timestamp: now - 9 * 60000, status: "read", reactions: [{ emoji: "🔥", users: ["u1"] }], evidenceTag: { type: "result", label: "Result", timestamp: now - 9 * 60000 } },
    ...
    { id: "m8", senderId: "u1", text: "Perfect. Here's the full experiment config file for reference.", time: "10:40 AM", timestamp: now - 5 * 60000, status: "read", reactions: [], attachments: [{ type: "file", name: "experiment_config.yaml", size: "12 KB" }] },
    { id: "m9", senderId: "me", text: "Got it. I'll review it tonight and cross-check with the original parameters.", time: "10:41 AM", timestamp: now - 4 * 60000, status: "delivered", reactions: [] },
