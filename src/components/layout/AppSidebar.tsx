...
import {
  ...
  ChevronDown, Microscope, FlaskConical, DollarSign, BookMarked, MessagesSquare } from
"lucide-react";
  ...
  return (
    <motion.aside
      ...
      <div className="flex items-center gap-0 px-4 h-16 border-b border-sidebar-border">
        <div className="w-[53px] h-[53px] rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
          <img alt="Think!Hub" className="w-[106px] h-[106px] object-cover contrast-125 brightness-110" src="/lovable-uploads/fb82a8d1-afee-4277-a87f-c1c9e6449a68.png" />
        </div>
        <AnimatePresence>
          {(!collapsed || isMobile) &&
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="overflow-hidden ml-[17px]">
