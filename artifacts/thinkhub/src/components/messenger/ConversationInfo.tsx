            ...
            <>
                ...
                <div className="px-2.5 py-2 rounded-lg bg-secondary/30 border border-border/50 mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[12px] font-display font-medium text-foreground truncate">{conversation.linkedProject}</p>
                    </div>
                  </div>
                </div>
              )}
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[12px] font-display font-medium text-foreground">
              ...
              <div className="space-y-0.5 mb-3">
                <button className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg hover:bg-secondary/40 transition-colors text-left">
                  ...
                  <span className="text-[12px] font-display text-foreground">{conversation.muted ? "Unmute" : "Mute"}</span>
                </button>
                <button
              ...
              <div className="space-y-0.5">
                <button className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg hover:bg-secondary/40 transition-colors text-left">
                  ...
                  <span className="text-[12px] font-display text-foreground">Archive</span>
                </button>
                <button className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg hover:bg-destructive/8 transition-colors text-left">
                  ...
                  <span className="text-[12px] font-display text-destructive">Delete conversation</span>
                </button>
              </div>
            </>
          )}
