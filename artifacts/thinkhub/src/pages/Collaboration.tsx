      ...
      <div className="max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-[22px] font-semibold tracking-tight text-foreground">Collaboration Hub</h1>
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 bg-success/10 text-success rounded-xl px-3.5 py-2">
                <Shield className="w-4 h-4" />
                <span className="text-[13px] font-display font-medium">Blockchain Audit</span>
              </div>
              <div className="flex items-center gap-1.5 bg-success/10 text-success rounded-xl px-3.5 py-2">
                <Radio className="w-4 h-4 animate-pulse" />
                <span className="text-[13px] font-display font-medium">Live</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <Tabs defaultValue="workspaces" className="space-y-4">
          <TabsList className="bg-card border border-border rounded-xl p-1">
            <TabsTrigger value="workspaces" className="font-display text-[13px] gap-1.5 px-3.5 py-2 rounded-xl">
              <Users className="w-4 h-4" /> Workspaces
            </TabsTrigger>
            <TabsTrigger value="chat" className="font-display text-[13px] gap-1.5 px-3.5 py-2 rounded-xl">
              <Radio className="w-4 h-4" /> Team Chat
            </TabsTrigger>
            <TabsTrigger value="audit" className="font-display text-[13px] gap-1.5 px-3.5 py-2 rounded-xl">
              <Shield className="w-4 h-4" /> Audit Trail
            </TabsTrigger>
            <TabsTrigger value="activity" className="font-display text-[13px] gap-1.5 relative px-3.5 py-2 rounded-xl">
              <Bell className="w-4 h-4" /> Activity
              {notifCount > 0 && (
                <Badge variant="secondary" className="ml-1.5 text-[9px] px-1.5 py-0 h-4 bg-accent/10 text-accent">
                  {notifCount}
                </Badge>
              )}
            </TabsTrigger>
          ...
          <TabsContent value="audit">
            <div className="bg-card rounded-xl border border-border p-5 space-y-4">
              <div>
                <h3 className="text-[15px] font-display font-semibold text-foreground mb-1">Blockchain Audit Trail</h3>
