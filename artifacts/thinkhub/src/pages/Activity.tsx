      ...
      <div className="max-w-5xl">
        <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-start justify-between mb-6 flex-wrap gap-3">
            ...
            <button className="h-9 px-4 rounded-lg bg-secondary text-foreground font-display font-medium text-sm flex items-center gap-2 hover:bg-secondary/80 transition-colors">
                      ...
                      <div className="space-y-2">
                        {entries.map((entry, i) => (
                          ...
                          >
                            ...
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 z-10 ${entry.iconBg} border border-border`}>
                              <entry.icon className={`w-3.5 h-3.5 ${entry.iconColor}`} />
                            </div>
