        ...
        <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          ...
          <div className="relative max-w-2xl mx-auto mb-3">
            ...
            <input type="text" value={searchQuery}
              ...
              className="w-full h-10 pl-12 pr-24 rounded-xl bg-card border border-border text-[13px] text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent shadow-sm" />
          ...
          <div className="flex items-center justify-center gap-2 flex-wrap">
            <button className="flex items-center justify-center h-8 px-3.5 rounded-full bg-secondary text-foreground text-[13px] font-medium hover:bg-secondary/80 transition-colors gap-1.5">
            ...
            {quickFilters.map(filter => (
              <button key={filter} onClick={() => toggleFilter(filter)}
                className={`flex items-center justify-center h-8 px-3.5 rounded-full border text-[13px] font-medium transition-all ${
