      ...
      <div className="bg-accent/3 border-b border-accent/10">
        ...
        <div className="px-4 py-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[12px] font-display font-semibold text-foreground">AI Co-pilot</span>
        ...
        {loading && responses.length === 0 && (
          <div className="px-4 py-4 flex items-center justify-center gap-2">
            ...
            <span className="text-[12px] text-muted-foreground font-display">Analyzing conversation…</span>
          </div>
        )}
      </div>
    </motion.div>
