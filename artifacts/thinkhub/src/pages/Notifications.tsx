  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-[15px] font-semibold text-foreground">Quick Summary</h3>
      </div>
...
function NotifCard({
  ...
  return (
    <motion.div
      ...
      className={`flex items-start gap-4 p-4 border-b border-border/50 transition-colors group cursor-pointer ${
        notif.read
          ? "bg-card hover:bg-secondary/30 " + PRIORITY_CONFIG.normal.border
          : `bg-accent/[0.03] hover:bg-secondary/30 ${priorityConfig.border}`
      }`}
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-3 mb-1">
          <h4 className={`text-[14px] leading-snug ${notif.read ? "text-foreground/75" : "text-foreground font-medium"}`}>
            {notif.title}
          </h4>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  ...
                  className="w-8 h-8 rounded-xl flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors opacity-0 group-hover:opacity-100"
                >
        ...
        <p className="text-[13px] text-muted-foreground leading-relaxed mb-3 line-clamp-2">{notif.description}</p>
    ...
    <AppLayout>
      <div className="max-w-4xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="bg-secondary/50 border border-border mb-4 flex-wrap h-auto gap-1 p-1 rounded-xl">
            <TabsTrigger value="all" className="text-[13px] px-3.5 py-2 rounded-xl">
              All
              {unreadCount > 0 && (
            ...
            <TabsTrigger value="unread" className="text-[13px] px-3.5 py-2 rounded-xl">Unread</TabsTrigger>
            <TabsTrigger value="citation" className="text-[13px] px-3.5 py-2 rounded-xl">Citations</TabsTrigger>
            <TabsTrigger value="collaboration" className="text-[13px] px-3.5 py-2 rounded-xl">Collabs</TabsTrigger>
            <TabsTrigger value="review" className="text-[13px] px-3.5 py-2 rounded-xl">Reviews</TabsTrigger>
            <TabsTrigger value="social" className="text-[13px] px-3.5 py-2 rounded-xl">Social</TabsTrigger>
            <TabsTrigger value="archived" className="text-[13px] px-3.5 py-2 rounded-xl">Archived</TabsTrigger>
            <TabsTrigger value="preferences" className="text-[13px] px-3.5 py-2 rounded-xl">
              <Settings className="w-3.5 h-3.5 mr-1.5" /> Prefs
            </TabsTrigger>
          </TabsList>
